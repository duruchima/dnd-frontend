                ...
                <label>
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Spells</InputLabel>
                        <Select labelId="bard-spellls" id="bard-spells-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Hideous Laughter"} value={"Hideous Laughter"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Hideous Laughter") > -1} />
                                <ListItemText primary={"Hideous Laughter"} />
                            </MenuItem>
                            <MenuItem key={"Identify"} value={"Identify"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Identify") > -1} />
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Skills</InputLabel>
                        <Select labelId="cleric-skills" id="cleric-skills-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Guiding Bolt"} value={"Guiding Bolt"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Guiding Bolt") > -1} />
                                <ListItemText primary={"Guiding Bolt"} />
                            </MenuItem>
                            <MenuItem key={"Healing Word"} value={"Healing Word"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Healing Word") > -1} />
                                <ListItemText primary={"Healing Word"} />
                            </MenuItem>
                            <MenuItem key={"Inflict Wounds"} value={"Inflict Wounds"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Inflict Wounds") > -1} />
                                <ListItemText primary={"Inflict Wounds"} />
                            </MenuItem>
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Skills</InputLabel>
                        <Select labelId="paladin-skills" id="paladin-skills-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Create Food and Water"} value={"Create Food and Water"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Create Food and Water") > -1} />
                                <ListItemText primary={"Create Food and Water"} />
                            </MenuItem>
                            <MenuItem key={"Daylight"} value={"Daylight"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Daylight") > -1} />
                                <ListItemText primary={"Daylight"} />
                            </MenuItem>
                            ...
                            <MenuItem key={"Magic Circle"} value={"Magic Circle"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Magic Circle") > -1} />
                                <ListItemText primary={"Magic Circle"} />
                            </MenuItem>
                            <MenuItem key={"Remove Curse"} value={"Remove Curse"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Remove Curse") > -1} />
                                <ListItemText primary={"Remove Curse"} />
                            </MenuItem>
                            <MenuItem key={"Revivify"} value={"Revivify"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Revivify") > -1} />
                                <ListItemText primary={"Revivify"} />
                            </MenuItem>
                        </Select>
                        </FormControl>
                    </> : null}
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Skills</InputLabel>
                        <Select labelId="ranger-skills" id="ranger-skills-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Locate Animals or Plants"} value={"Locate Animals or Plants"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Locate Animals or Plants") > -1} />
                                <ListItemText primary={"Locate Animals or Plants"} />
                            </MenuItem>
                            <MenuItem key={"Locate Object"} value={"Locate Object"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Locate Object") > -1} />
                                <ListItemText primary={"Locate Object"} />
                            </MenuItem>
                            <MenuItem key={"Pass Without Trace"} value={"Pass Without Trace"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Pass Without Trace") > -1} />
                                <ListItemText primary={"Pass Without Trace"} />
                            </MenuItem>
                            <MenuItem key={"Protection from Poison"} value={"Protection from Poison"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Protection from Poison") > -1} />
                                <ListItemText primary={"Protection from Poison"} />
                            </MenuItem>
                            <MenuItem key={"Silence"} value={"Silence"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Silence") > -1} />
                                <ListItemText primary={"Silence"} />
                            </MenuItem>
                            <MenuItem key={"Spike Growth"} value={"Spike Growth"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Spike Growth") > -1} />
                                <ListItemText primary={"Spike Growth"} />
                            </MenuItem>
                            <MenuItem key={"Conjure Animals"} value={"Conjure Animals"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Conjure Animals") > -1} />
                                <ListItemText primary={"Conjure Animals"} />
                            </MenuItem>
                            <MenuItem key={"Daylight"} value={"Daylight"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Daylight") > -1} />
                                <ListItemText primary={"Daylight"} />
                            </MenuItem>
                            <MenuItem key={"Nondetection"} value={"Nondetection"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Nondetection") > -1} />
                                <ListItemText primary={"Nondetection"} />
                            </MenuItem>
                        </Select>
                        </FormControl>
                    </> : null}
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Skills</InputLabel>
                        <Select labelId="sorcerer-skills" id="sorcerer-skills-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Silent Image"} value={"Silent Image"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Silent Image") > -1} />
                                <ListItemText primary={"Silent Image"} />
                            </MenuItem>
                            <MenuItem key={"Sleep"} value={"Sleep"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Sleep") > -1} />
                                <ListItemText primary={"Sleep"} />
                            </MenuItem>
                            <MenuItem key={"Thunderwave"} value={"Thunderwave"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Thunderwave") > -1} />
                                <ListItemText primary={"Thunderwave"} />
                            </MenuItem>
                        </Select>
                        </FormControl>
                    </> : null}
                    ...
                    <InputLabel>Select {this.state.currentClassObj.num_of_proficiency_choices} Skills</InputLabel>
                        <Select labelId="warlock-skills" id="warlock-skills-checkbox" multiple value={this.state.charSkills} onChange={this.handleChange} input={<Input />}
                            ...
                            <MenuItem key={"Fear"} value={"Fear"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Fear") > -1} />
                                <ListItemText primary={"Fear"} />
                            </MenuItem>
                            <MenuItem key={"Fly"} value={"Fly"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Fly") > -1} />
                                <ListItemText primary={"Fly"} />
                            </MenuItem>
                            <MenuItem key={"Gaseous Form"} value={"Gaseous Form"}>
                                <Checkbox checked={this.state.charSkills.indexOf("Gaseous Form") > -1} />
                                <ListItemText primary={"Gaseous Form"} />
                            </MenuItem>
                        </Select>
                        </FormControl>
                    </> : null}
